...
<head>
    ...
    <title>Tambah Owner - CV Wijaya</title>
...
<div class="d-flex">
    ...
    <main class="flex-grow-1 p-4">
        <div class="mb-4">
            ...
            <h4 class="fw-bold"><i class="bi bi-plus-circle me-2 text-primary"></i>Tambah Owner Baru</h4>
        </div>

        <div class="card shadow-sm">
            <div class="card-header bg-white py-3">
                <span class="fw-semibold text-muted"><i class="bi bi-pencil-square me-1"></i>Form Data Owner</span>
            </div>
            <div class="card-body">
                <form action="{{ route('owner.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="jabatan" id="jabatan" class="form-control @error('jabatan') is-invalid @enderror" placeholder="Contoh: Owner, Komisaris Utama" value="{{ old('jabatan') }}">
                            @error('jabatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Password -->
                        <div class="col-md-6">
                            <label for="password" class="form-label fw-semibold text-muted small">Password Login <span class="text-danger">*</span></label>
                        ...
                        <!-- Confirm Password -->
                        <div class="col-md-6">
                            <label for="password_confirmation" class="form-label fw-semibold text-muted small">Konfirmasi Password <span class="text-danger">*</span></label>
                        ...
                        <div class="col-12 mt-4 text-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-1"></i>Simpan Owner
                            </button>
                        </div>
                    </div>
                </form>
