...
<head>
    ...
    <title>Edit Supplier - CV Wijaya Las</title>
...
<div class="d-flex">
    ...
    <main class="flex-grow-1 p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold mb-0"><i class="bi bi-pencil-square me-2 text-warning"></i>Update Data Supplier</h4>
            <a href="{{ route('admin.suppliers.index') }}" class="btn btn-outline-secondary btn-sm">
                <i class="bi bi-arrow-left me-1"></i>Kembali
            </a>
        </div>

        {{-- Tampil Pesan Error (sesuai activity diagram - kondisi False dari menvalidasi) --}}
        @if($errors->any())
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <i class="bi bi-exclamation-triangle me-2"></i>
                <strong>Update gagal! Data tidak valid:</strong>
                <ul class="mb-0 mt-2">
        ...
        {{-- Menampilkan Form Update Data Supplier (sesuai activity diagram) --}}
        <div class="card shadow-sm" style="max-width: 700px;">
            <div class="card-header bg-warning bg-opacity-10 border-0 py-3">
                <h6 class="mb-0 text-warning fw-bold">
                    <i class="bi bi-pencil me-2"></i>Form Update Data Supplier: <em>{{ $supplier->nama_supplier }}</em>
                </h6>
            </div>
            <div class="card-body">
                {{-- update data suplier (sesuai activity diagram) --}}
                <form action="{{ route('admin.suppliers.update', $supplier->id) }}" method="POST">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-warning">
                            <i class="bi bi-arrow-repeat me-1"></i>Update Supplier
                        </button>
