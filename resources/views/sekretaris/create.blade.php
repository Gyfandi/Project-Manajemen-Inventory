...
<head>
    ...
    <title>Tambah Sekretaris - CV Wijaya</title>
...
<div class="d-flex">
    ...
    <main class="flex-grow-1 p-4">
        <div class="mb-4">
            ...
            <h4 class="fw-bold"><i class="bi bi-plus-circle me-2 text-primary"></i>Tambah Sekretaris Baru</h4>
        </div>

        <div class="card shadow-sm">
            <div class="card-header bg-white py-3">
                <span class="fw-semibold text-muted"><i class="bi bi-pencil-square me-1"></i>Form Data Sekretaris</span>
            </div>
            <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 mt-4 text-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-1"></i>Simpan Sekretaris
                            </button>
                        </div>
                    </div>
                </form>
